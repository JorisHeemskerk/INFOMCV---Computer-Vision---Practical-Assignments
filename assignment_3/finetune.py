...
def finetune_TinyImageNet(
    ...
    """
    Finetune a model on the TinyImageNet dataset.

    Change the output size of the given model to match the amount of
    classes in the TinyImageNet dataset. Then train this model on the 
    TinyImageNet dataset with the learning rate halved from what it was
    during pre-training.
